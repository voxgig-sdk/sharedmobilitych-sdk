...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SHAREDMOBILITYCH_TEST_LIVE ||
    'TRUE' === process.env.SHAREDMOBILITYCH_TEST_OVERRIDE
  ) {
  ...
  m.SHAREDMOBILITYCH_TEST_EXPLAIN = process.env.SHAREDMOBILITYCH_TEST_EXPLAIN || m.SHAREDMOBILITYCH_TEST_EXPLAIN
