# Sharedmobilitych TypeScript SDK

The TypeScript SDK for the Sharedmobilitych API. Provides a type-safe, entity-oriented interface with full async/await support.
...
| `tester(testopts?, sdkopts?)` | `SharedmobilitychSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SharedmobilitychSDK.test(testopts?, sdkopts?)` | `SharedmobilitychSDK` | Create a test-mode client. |
...
sharedmobilitych/
├── src/
│   ├── SharedmobilitychSDK.ts        # Main SDK class
