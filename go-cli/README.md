...
AQL-driven CLI and REPL for the Sharedmobilitych SDK. Positional arguments are
...
```sh
go build -o sharedmobilitych-cli ./...
```
...
./sharedmobilitych-cli list asset
./sharedmobilitych-cli load 1 asset
./sharedmobilitych-cli load '{id:1}' asset
