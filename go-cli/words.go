...
func registerSDKWords(r *eng.Registry, client *sdk.SharedmobilitychSDK) {
...
func runOp(client *sdk.SharedmobilitychSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
