...
from projectname_sdk.core.control import SharedmobilitychControl
...
class SharedmobilitychContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SharedmobilitychControl()
        ...
        if isinstance(sp, SharedmobilitychSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SharedmobilitychResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SharedmobilitychResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SharedmobilitychOperation({})
    ...
    def make_error(self, code, msg):
        return SharedmobilitychError(code, msg, self)
