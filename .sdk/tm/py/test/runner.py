...
class SharedmobilitychTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SharedmobilitychTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SharedmobilitychTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SharedmobilitychTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
