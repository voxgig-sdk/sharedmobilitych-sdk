...
// Sharedmobilitych SDK utility type

class SharedmobilitychUtility
{
    ...
    public static function copy(SharedmobilitychUtility $src): SharedmobilitychUtility
    {
        $u = new SharedmobilitychUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
