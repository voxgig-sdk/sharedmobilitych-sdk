...
// Sharedmobilitych SDK utility: fetcher

class SharedmobilitychFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SharedmobilitychSDK/1.0)';
    ...
    public static function call(SharedmobilitychContext $ctx, string $fullurl, array $fetchdef): array
    {
