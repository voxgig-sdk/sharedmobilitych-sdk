...
// Sharedmobilitych SDK netsim feature
...
class SharedmobilitychNetsimFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _simulate(SharedmobilitychContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SharedmobilitychContext $ctx, array $applied): void
    {
        $client = $this->client;
