...
// Sharedmobilitych SDK clienttrack feature
...
class SharedmobilitychClienttrackFeature extends SharedmobilitychBaseFeature
{
    ...
    public function PostConstruct(SharedmobilitychContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Sharedmobilitych-SDK';
