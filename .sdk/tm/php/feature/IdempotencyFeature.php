...
// Sharedmobilitych SDK idempotency feature
...
class SharedmobilitychIdempotencyFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _mutating(SharedmobilitychContext $ctx): bool
    {
