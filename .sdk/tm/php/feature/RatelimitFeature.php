...
// Sharedmobilitych SDK ratelimit feature
...
class SharedmobilitychRatelimitFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _acquire(SharedmobilitychContext $ctx): void
    {
    ...
    private function _track(SharedmobilitychContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
