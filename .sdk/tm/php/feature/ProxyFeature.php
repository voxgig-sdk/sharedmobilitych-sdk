...
// Sharedmobilitych SDK proxy feature
...
class SharedmobilitychProxyFeature extends SharedmobilitychBaseFeature
{
    ...
    public function init(SharedmobilitychContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SharedmobilitychContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
