...
describe("AttributeDirect", function()
  it("should direct-list-attribute", function()
    local setup = attribute_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-attribute", setup.live and "live" or "unit")
