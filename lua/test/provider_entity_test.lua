...
describe("ProviderEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SHAREDMOBILITYCH_TEST_PROVIDER_ENTID JSON to run live")
      return
    end
...
function provider_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SHAREDMOBILITYCH_TEST_PROVIDER_ENTID")
