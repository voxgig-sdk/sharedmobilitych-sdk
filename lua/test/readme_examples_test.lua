...
local SDK_MODULE = "sharedmobilitych_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["asset"] = { ["test01"] = { id = "test01" } }, ["attribute"] = { ["test01"] = { id = "test01" } }, ["provider"] = { ["test01"] = { id = "test01" } }, ["region"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } } } }'
