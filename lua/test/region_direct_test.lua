...
describe("RegionDirect", function()
  it("should direct-list-region", function()
    local setup = region_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-region", setup.live and "live" or "unit")
