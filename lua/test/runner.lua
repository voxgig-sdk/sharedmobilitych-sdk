...
function runner.env_override(m)
  local live = runner.getenv("SHAREDMOBILITYCH_TEST_LIVE")
  local override = runner.getenv("SHAREDMOBILITYCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SHAREDMOBILITYCH_TEST_EXPLAIN")
