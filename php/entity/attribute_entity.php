...
class AttributeEntity
{
     ...
     *
     * @param AttributeListMatch|array|null $reqmatch Match filter (any subset
     *   of Attribute fields) as an assoc-array; AttributeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Attribute[]|array A list of Attribute items as assoc-arrays at
