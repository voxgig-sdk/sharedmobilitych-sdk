...
// Sharedmobilitych SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SharedmobilitychTransformResponse
{
    public static function call(SharedmobilitychContext $ctx): mixed
    {
        ...
        $transform = SharedmobilitychHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
