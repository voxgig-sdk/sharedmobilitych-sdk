...
// Sharedmobilitych SDK utility: graphql
//
...
class SharedmobilitychGraphql
{
    ...
    // equivalent.
    public static function body(SharedmobilitychContext $ctx): mixed
    {
    ...
    public static function errors(SharedmobilitychContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
