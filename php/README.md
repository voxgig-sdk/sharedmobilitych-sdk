# Sharedmobilitych PHP SDK

The PHP SDK for the Sharedmobilitych API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Asset(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Sharedmobilitych(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── sharedmobilitych_sdk.php          -- Main SDK class
...
The main class (`sharedmobilitych_sdk.php`) exports the SDK class
