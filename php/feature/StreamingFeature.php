...
// Sharedmobilitych SDK streaming feature
...
class SharedmobilitychStreamingFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _iterate(SharedmobilitychResult $result): \Generator
    {
    ...
    private function _streamable(SharedmobilitychContext $ctx): bool
    {
