...
// Sharedmobilitych SDK timeout feature
...
class SharedmobilitychTimeoutFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _with_timeout(SharedmobilitychContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SharedmobilitychContext $_ctx, float $ms): void
    {
        $client = $this->client;
