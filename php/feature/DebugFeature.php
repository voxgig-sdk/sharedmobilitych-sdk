...
// Sharedmobilitych SDK debug feature
...
class SharedmobilitychDebugFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _finish(SharedmobilitychContext $ctx, bool $ok): void
    {
