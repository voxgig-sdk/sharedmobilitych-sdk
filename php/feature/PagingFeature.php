...
// Sharedmobilitych SDK paging feature
...
class SharedmobilitychPagingFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _is_list(SharedmobilitychContext $ctx): bool
    {
