...
// Sharedmobilitych SDK audit feature
...
class SharedmobilitychAuditFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _emit(SharedmobilitychContext $ctx, string $outcome): void
    {
