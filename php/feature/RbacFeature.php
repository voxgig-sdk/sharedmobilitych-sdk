...
// Sharedmobilitych SDK rbac feature
...
class SharedmobilitychRbacFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _required(SharedmobilitychContext $ctx): ?string
    {
    ...
    private function _reject(SharedmobilitychContext $ctx, string $required): void
    {
    ...
    private function _track(SharedmobilitychContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
