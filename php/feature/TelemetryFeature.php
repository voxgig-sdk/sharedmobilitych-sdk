...
// Sharedmobilitych SDK telemetry feature
...
class SharedmobilitychTelemetryFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _close(SharedmobilitychContext $ctx, bool $ok): void
    {
