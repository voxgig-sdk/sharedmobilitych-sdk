...
// Sharedmobilitych SDK cache feature
...
class SharedmobilitychCacheFeature extends SharedmobilitychBaseFeature
{
    ...
    private function _through(SharedmobilitychContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
