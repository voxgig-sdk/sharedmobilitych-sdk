...
class SharedmobilitychTestRunner
{
    ...
    {
        $live = self::getenv('SHAREDMOBILITYCH_TEST_LIVE');
        $override = self::getenv('SHAREDMOBILITYCH_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SHAREDMOBILITYCH_TEST_EXPLAIN');
...
class_alias('SharedmobilitychTestRunner', 'Runner');
class_alias('SharedmobilitychHelpers', 'Helpers');
