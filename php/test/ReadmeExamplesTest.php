...
// Sharedmobilitych SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SharedmobilitychSDK::test)
...
{
    private const SDK_CLASS = 'SharedmobilitychSDK';
    ...
    private const SDK_BASE = 'sharedmobilitych_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../sharedmobilitych_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
