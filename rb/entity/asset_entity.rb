# Sharedmobilitych SDK Asset entity
...
class AssetEntity
  ...
  # @return [Asset, Hash] the loaded Asset; raises SharedmobilitychError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = SharedmobilitychHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
