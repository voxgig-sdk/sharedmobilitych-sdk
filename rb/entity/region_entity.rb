...
class RegionEntity
  ...
  #
  # @param reqmatch [RegionListMatch, Hash, nil] match filter (any subset of
  #   Region fields); defaults to nil, treated as an empty match that lists all.
