# Sharedmobilitych SDK Provider entity
...
class ProviderEntity
  ...
  def make
    opts = @_entopts.dup
    ProviderEntity.new(@_client, opts)
  end
  ...
  # @return [Provider, Hash] the current Provider data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Provider fields)
  def match_get
  ...
  #
  # @param reqmatch [ProviderListMatch, Hash, nil] match filter (any subset of
  #   Provider fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Provider>, Array] the matching Provider items; raises SharedmobilitychError on failure
