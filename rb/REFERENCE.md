# Sharedmobilitych Ruby SDK Reference

Complete API reference for the Sharedmobilitych Ruby SDK.
...
#### `SharedmobilitychSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Provider.list(nil)
```
