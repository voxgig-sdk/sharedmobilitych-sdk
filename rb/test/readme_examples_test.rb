...
#      offline in seeded test mode (SharedmobilitychSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Sharedmobilitych_sdk.rb")
  SDK_CLASS = "SharedmobilitychSDK"
