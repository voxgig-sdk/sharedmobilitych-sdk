...
module SharedmobilitychTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("SHAREDMOBILITYCH_TEST_LIVE")
    override = getenv("SHAREDMOBILITYCH_TEST_OVERRIDE")
    ...
    explain = getenv("SHAREDMOBILITYCH_TEST_EXPLAIN")
    m["SHAREDMOBILITYCH_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = SharedmobilitychTestRunner
Helpers = SharedmobilitychHelpers
Vs = VoxgigStruct
