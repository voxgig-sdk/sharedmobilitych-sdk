// Command Sharedmobilitych-mcp is an MCP server exposing the Sharedmobilitych
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Sharedmobilitych_list  — list records of an entity
//	Sharedmobilitych_load  — load a single record of an entity
//
