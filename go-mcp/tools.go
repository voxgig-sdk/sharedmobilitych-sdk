...
type Args struct {
	Entity string         `json:"entity" jsonschema:"asset | attribute | provider | region | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SharedmobilitychSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sharedmobilitych_list",
		Description: "List records from Sharedmobilitych. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sharedmobilitych_load",
		Description: "Load a single record from Sharedmobilitych. " +
...
func runOp(client *sdk.SharedmobilitychSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SharedmobilitychSDK, name string) (sdk.SharedmobilitychEntity, error) {
