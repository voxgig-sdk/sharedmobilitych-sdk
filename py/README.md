...
The Python SDK for the Sharedmobilitych API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/sharedmobilitych-sdk/releases)) or
