# Sharedmobilitych SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SharedmobilitychSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SharedmobilitychSDK(...) and SharedmobilitychSDK.test(...) become
#      SharedmobilitychSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "sharedmobilitych_sdk"
_SDK_CLASS = "SharedmobilitychSDK"
