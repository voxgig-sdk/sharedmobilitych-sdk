...
from sharedmobilitych_sdk.utility import register
...
class SharedmobilitychSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SharedmobilitychUtility()
    ...
    def get_utility(self):
        return SharedmobilitychUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SharedmobilitychSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Asset(self, data=None) -> "AssetEntity":
        ...
        from sharedmobilitych_sdk.entity.asset_entity import AssetEntity
    ...
    def Attribute(self, data=None) -> "AttributeEntity":
        ...
        from sharedmobilitych_sdk.entity.attribute_entity import AttributeEntity
    ...
    def Provider(self, data=None) -> "ProviderEntity":
        ...
        from sharedmobilitych_sdk.entity.provider_entity import ProviderEntity
    ...
    def Region(self, data=None) -> "RegionEntity":
        ...
        from sharedmobilitych_sdk.entity.region_entity import RegionEntity
        return RegionEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from sharedmobilitych_sdk.entity.search_entity import SearchEntity
