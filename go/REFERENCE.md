# Sharedmobilitych Golang SDK Reference

Complete API reference for the Sharedmobilitych Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *SharedmobilitychSDK`
