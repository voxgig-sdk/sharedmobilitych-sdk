...
const testSeed = `map[string]any{"entity": map[string]any{"asset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "attribute": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "provider": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
