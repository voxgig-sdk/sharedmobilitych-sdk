...
type SharedmobilitychSDK struct {
	Mode     string
...
func (sdk *SharedmobilitychSDK) OptionsMap() map[string]any {
...
func (sdk *SharedmobilitychSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SharedmobilitychSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SharedmobilitychSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SharedmobilitychSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SharedmobilitychSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SharedmobilitychSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SharedmobilitychSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SharedmobilitychSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SharedmobilitychSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SharedmobilitychSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SharedmobilitychSDK {
	...
	sdk := NewSharedmobilitychSDK(sdkopts)
	sdk.Mode = "test"
