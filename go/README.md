# Sharedmobilitych Golang SDK



The Golang SDK for the Sharedmobilitych API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/sharedmobilitych-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/sharedmobilitych-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/sharedmobilitych-sdk/go=../sharedmobilitych-sdk/go
```
...
### NewSharedmobilitychSDK

```go
func NewSharedmobilitychSDK(options map[string]any) *SharedmobilitychSDK
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SharedmobilitychSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### SharedmobilitychSDK methods
...
| `Asset` | `(data map[string]any) SharedmobilitychEntity` | Create an Asset entity instance. |
| `Attribute` | `(data map[string]any) SharedmobilitychEntity` | Create an Attribute entity instance. |
| `Provider` | `(data map[string]any) SharedmobilitychEntity` | Create a Provider entity instance. |
| `Region` | `(data map[string]any) SharedmobilitychEntity` | Create a Region entity instance. |
| `Search` | `(data map[string]any) SharedmobilitychEntity` | Create a Search entity instance. |

### Entity interface (SharedmobilitychEntity)

All entities implement the `SharedmobilitychEntity` interface.
