...
type RegionEntity struct {
	name    string
	client  *core.SharedmobilitychSDK
...
func NewRegionEntity(client *core.SharedmobilitychSDK, entopts map[string]any) *RegionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegionEntity) GetName() string { return e.name }
...
func (e *RegionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegionEntity) Deleted() bool {
	return e.deleted
}


func (e *RegionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegionEntity(e.client, opts)
}

func (e *RegionEntity) Data(args ...any) any {
...
func (e *RegionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Region; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RegionEntity) DataTyped(data ...Region) Region {
	if len(data) > 0 {
		return typedFrom[Region](e.Data(asMap(data[0])))
	}
	return typedFrom[Region](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Region (all fields
// optional at the wire level).
func (e *RegionEntity) MatchTyped(match ...Region) Region {
	if len(match) > 0 {
		return typedFrom[Region](e.Match(asMap(match[0])))
	}
	return typedFrom[Region](e.Match())
}
...
func (e *RegionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RegionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RegionListMatch and returns []Region. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RegionEntity) ListTyped(reqmatch RegionListMatch, ctrl map[string]any) ([]Region, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Region](res), nil
}



func (e *RegionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RegionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
